...
$(function () {
  //menu toogle
  var menuItem = $('#navbar .nav-item');
  var mainContent = $('.js_mainContent');
  ...
  var chart = c3.generate({
    ...
    data: {
      x: 'x',
      columns: [['x', '18 JUN', '19 JUN', '20 JUN', '21 JUN', '22 JUN', '23 JUN'], ['TOTAL REVENUE', 5000, 2000, 3000, 4500, 6000, 8000], ['TOTAL COST', 500, 800, 1200, 1500, 750, 800], ['NET INCOME', 4500, 1200, 1800, 3000, 5250, 7200]]
    },
    color: {

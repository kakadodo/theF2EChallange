...
var SceneStart = function (_Phaser$Scene2) {
  ...
  _createClass(SceneStart, [{
    ...
    value: function init() {
      ...
      // 限制邊界在池塘中
      this.physics.world.setBounds(uiConfig.gridColWidth * 3, -uiConfig.gridColHeight * 5, uiConfig.gridColWidth * 10, uiConfig.gridColHeight * 15);
    ...
    value: function create() {
      ...
      this.physics.add.collider(this.ballGroup, this.superStarGroup);
    ...
    value: function update() {
      if (modal.isPlay) {
        ...
        // physics collider
        this.physics.add.collider(this.ballGroup, this.boss1);
        this.physics.add.collider(this.ballGroup, this.boss2);
